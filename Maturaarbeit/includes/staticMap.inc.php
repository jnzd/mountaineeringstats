<div class="staticMap">
  <?  
    ...
    $link = "https://maps.googleapis.com/maps/api/staticmap?size=640x360&center=".$latCenter.",".$longCenter."&zoom=14&path=weight:3%7Ccolor:blue%7Cenc:".$encodedCoords."&key=AIzaSyBh619HIPkaPOW76qYCe5_39VpnJRhWu2s";
    $track = [];
    ...
    while(strlen($link)>8192){
      ...
      $encodedCoords = Polyline::encode($track);
      $link = "https://maps.googleapis.com/maps/api/staticmap?size=640x360&center=".$latCenter.",".$longCenter."&path=weight:3%7Ccolor:blue%7Cenc:".$encodedCoords."&key=AIzaSyBh619HIPkaPOW76qYCe5_39VpnJRhWu2s";
    }
